...
public class PassengerModel {
    ...
    public String getPassengerTicketStr(MyTicketInfoModel myTicketInfoModel) {
        PassengerModel passengerModel = myTicketInfoModel.getPassengerModel();
        return myTicketInfoModel.getSeat().get(0).getCode() + "," +
